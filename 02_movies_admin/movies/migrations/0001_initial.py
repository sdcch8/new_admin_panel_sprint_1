...
class Migration(migrations.Migration):
    ...
    replaces = [('movies', '0001_initial'), ('movies', '0002_filmwork_film_work_pkey_filmwork_film_work_title_idx_and_more'), ('movies', '0003_filmwork_film_work_pkey_genre_genre_pkey_and_more'), ('movies', '0004_remove_genrefilmwork_film_work_genre_idx_and_more'), ('movies', '0005_alter_personfilmwork_role')]
